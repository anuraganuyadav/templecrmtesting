...
{ 
 //  filter
  ...
  if(empty($_POST["filterDateBefore"])){
   ...
   if(empty($result['leadFdate'])){
     $Fdate ="All";  
   } 
   else{
    $Fdate =$result['leadFdate'];   
     } 
   if(empty($result['leadLdate'])){
      $Ldate ="All";  
     }
    else{
     $Ldate =$result['leadLdate'];   
    }
...
$query = "SELECT * FROM potential WHERE  last_response = '' ";      
} 
...
$query = "SELECT * FROM potential WHERE  last_response = '$filterStatus' ";      
} 
...
$query = "SELECT * FROM potential WHERE sales_person = '$filterSales' ";      
} 
...
$query = "SELECT * FROM potential WHERE 	sales_person = '$filterSales' and last_response = '' ";      
} 
...
$query = "SELECT * FROM potential WHERE 	sales_person = '$filterSales' and last_response = '$filterStatus' ";      
} 
...
$query = "SELECT * FROM potential WHERE sales_person = '$filterSales' ORDER BY $filterType" ;      
} 
...
$query = "SELECT * FROM potential WHERE TIMESTAMP(`$filterType`) >=( NOW() - INTERVAL 0 DAY ) ";      
} 
...
$query = "SELECT * FROM potential WHERE TIMESTAMP(`$filterType`) >=( NOW() - INTERVAL 0 DAY ) and  last_response = '' ";      
} 
...
$query = "SELECT * FROM potential WHERE TIMESTAMP(`$filterType`) >=( NOW() - INTERVAL 0 DAY ) and  last_response = '$filterStatus' ";      
} 
...
$query = "SELECT * FROM potential WHERE 	sales_person ='$filterSales' and TIMESTAMP(`$filterType`) >=( NOW() - INTERVAL 0 DAY ) ";      
} 
...
$query = "SELECT * FROM potential WHERE 	sales_person ='$filterSales' and TIMESTAMP(`$filterType`) >=( NOW() - INTERVAL 0 DAY ) and  last_response = '' ";      
} 
...
$query = "SELECT * FROM potential WHERE 	sales_person = '$filterSales' and TIMESTAMP(`$filterType`) >=( NOW() - INTERVAL 0 DAY ) and  last_response = '$filterStatus' ";      
} 
...
$query = "SELECT * FROM potential WHERE $filterType >= '$Fdate' AND $filterType <= '$Ldate' ";      
} 
...
$query = "SELECT * FROM potential WHERE $filterType >= '$Fdate' AND $filterType <= '$Ldate' and  last_response = '' ";      
} 
...
$query = "SELECT * FROM potential WHERE $filterType >= '$Fdate' AND $filterType <= '$Ldate' and  last_response = '$filterStatus' ";      
} 
...
$query = "SELECT * FROM potential WHERE sales_person = '$filterSales' and $filterType >= '$Fdate' AND $filterType <= '$Ldate' ";      
} 
...
$query = "SELECT * FROM potential WHERE 	sales_person = '$filterSales' and $filterType >= '$Fdate' AND $filterType <= '$Ldate' and  last_response = '' ";      
} 
...
$query = "SELECT * FROM potential WHERE sales_person = '$filterSales' and $filterType >= '$Fdate' AND $filterType <= '$Ldate' and  last_response = '$filterStatus' ";      
}  
else{            
 echo "No data found";
