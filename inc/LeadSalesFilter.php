...
{	
    ...
    $leadDateType = filter_var($_POST["leadDateType"]);  
 ...
 // condition 1    
  if($count != 1){ 
   if(mysqli_query($conn,"INSERT INTO filter (filterID, filterDateBefore, AdminfilterSales, filterStatus,leadDateType,leadFdate,leadLdate) VALUES ('$userID','$filterDateBefore','$AdminfilterSales', '$filterStatus', '$leadDateType', '$leadFdate', '$leadLdate')")){
...
// condition 2     
     ...
     if(mysqli_query($conn,"UPDATE filter SET filterDateBefore = '$filterDateBefore', AdminfilterSales = '$AdminfilterSales', filterStatus = '$filterStatus', leadDateType = '$leadDateType', leadFdate = '$leadFdate', leadLdate = '$leadLdate' WHERE filterID= $userID")){
