...
//MySQL query
$Result = mysqli_query($conn,"SELECT id, status_list FROM status ORDER BY id");
//get all records from add_delete_record table
while($row = mysqli_fetch_array($Result))
{
?> <div class="input-group margin-top-5"> 
    <span class="res-list"><?php echo $row["status_list"];?></span>
           <div class="input-group-prepend">
...
$(document).ready(function() {
	...
	$("#FormSubmit").click(function (e) {
			...
			url: "inc/response_status.php", //Where form data is sent on submission
