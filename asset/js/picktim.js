  ...
  function Plugin(element, options) {
    ...
    if (this.settings.defaultValue === "now") {
      ...
      this.setDefaultValue(
        ("0" + curTim.getHours()).slice(-2) +
          ":" +
          ("0" + curTim.getMinutes()).slice(-2)
      );
    }
    ...
    this.input.attr("placeholder", "Time");
    ...
    if (this.settings.mode === this.MODES.h24) {
      this.tPopup
        .get(0)
        .style.setProperty("--picktim-container-width", "150px");
    } else {
      this.tPopup
        .get(0)
        .style.setProperty("--picktim-container-width", "200px");
    }
    this.setOrientation();
    this.tPopup.hide();
    ...
    this.cTable.topRow.append(
      this.cTable.topRow.c1,
      this.cTable.topRow.c2,
      this.cTable.topRow.c3,
      this.cTable.topRow.c4
    );
    this.cTable.midRow.c1 = $("<td>");
    this.cTable.midRow.c2 = $("<td>");
    this.cTable.midRow.c3 = $("<td>");
    this.cTable.midRow.c4 = $("<td>");
    this.cTable.midRow.append(
      this.cTable.midRow.c1,
      this.cTable.midRow.c2,
      this.cTable.midRow.c3,
      this.cTable.midRow.c4
    );
    this.cTable.botRow.c1 = $("<td>");
    this.cTable.botRow.c2 = $("<td>");
    this.cTable.botRow.c3 = $("<td>");
    this.cTable.botRow.c4 = $("<td>");
    this.cTable.botRow.append(
      this.cTable.botRow.c1,
      this.cTable.botRow.c2,
      this.cTable.botRow.c3,
      this.cTable.botRow.c4
    );
    this.tHours = $("<input>");
  ...
  Plugin.prototype.updateInput = function () {
    ...
    if (this.settings.mode === this.MODES.h24) {
      ...
      if (this.ampm.text() === "AM") {
        ...
        this.input.val(
          parseInt(this.tHours.val()) + 12 + ":" + this.tMins.val()
        );
      }
    }
  };
